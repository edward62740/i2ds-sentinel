...
#define KEYSPEC_ATTRIBUTES_ECC_DO█████████       (1U << 12)
                                     ...
                                     uint32_t *storage_size)
{
  ...
  bool has_custom_curve =
    ((key->flags & SL_SE_KEY_FLAG_ASYMMETRIC_USES_CUSTOM_DO█████████) != 0);
  #else
                                     ...
                                     bool public_export)
{
  ...
  if ((key_1->type & SL_SE_KEY_TYPE_ALGORITHM_MASK)
    ...
    uint32_t consistent_flags =
      (public_export) ? SL_SE_KEY_FLAG_ASYMMETRIC_USES_CUSTOM_DO█████████
      : (SL_SE_KEY_FLAG_ASYMMETRIC_BUFFER_HAS_PUBLIC_KEY
         | SL_SE_KEY_FLAG_ASYMMETRIC_BUFFER_HAS_PRIVATE_KEY
         | SL_SE_KEY_FLAG_ASYMMETRIC_USES_CUSTOM_DO█████████);
                                  ...
                                  uint32_t *keyspec)
{
  ...
  *keyspec = (key->type & KEYSPEC_TYPE_MASK);
  ...
  switch (key->storage.method) {
    ...
    case SL_SE_KEY_STORAGE_█████████_VOLATILE:
      *keyspec |= KEYSPEC_MODE_VOLATILE;
      break;
#endif

    case SL_SE_KEY_STORAGE_█████████_IMMUTABLE:
      *keyspec |= KEYSPEC_MODE_VOLATILE;
      break;
  ...
  if (key->flags & SL_SE_KEY_FLAG_IS_DEVICE_GENERATED) {
    keyspec_restriction = KEYSPEC_RESTRICTION_█████████;
  }
  ...
  *keyspec = (*keyspec & ~KEYSPEC_RESTRICTION_MASK)
...
#if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
  if (key->storage.method == SL_SE_KEY_STORAGE_█████████_VOLATILE) {
  ...
  if (key->storage.method == SL_SE_KEY_STORAGE_█████████_IMMUTABLE) {
  ...
  #if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
    if (has_custom_curve) {
      *keyspec |= KEYSPEC_ATTRIBUTES_ECC_DO█████████;
    }
  #endif
...
#if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
  else if (keyspec_restriction == KEYSPEC_RESTRICTION_█████████) {
...
#if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
  bool has_custom_curve = ((keyspec & KEYSPEC_ATTRIBUTES_ECC_DO█████████) != 0);
#endif
...
#if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
    if (has_custom_curve) {
      key->flags |= SL_SE_KEY_FLAG_ASYMMETRIC_USES_CUSTOM_DO█████████;
                                        ...
                                        SE_DataTransfer_t *buffer)
{
  ...
  } else if ((key->storage.method == SL_SE_KEY_STORAGE_█████████_IMMUTABLE)
#if (_SILICON_LABS_SECURITY_FEATURE == _SILICON_LABS_SECURITY_FEATURE_VAULT)
             || (key->storage.method == SL_SE_KEY_STORAGE_█████████_VOLATILE)
#endif
             ) {
                               ...
                               const sl_se_key_descriptor_t *key_out)
{
  ...
  if (key_out->flags & SL_SE_KEY_FLAG_ASYMMETRIC_USES_CUSTOM_DO█████████) {
                             ...
                             const sl_se_key_descriptor_t *key_out)
{
  ...
  if ((key_in->storage.method != SL_SE_KEY_STORAGE_EXTERNAL_PLAINTEXT)
      || ((key_out->storage.method != SL_SE_KEY_STORAGE_█████████_VOLATILE)
                             ...
                             const sl_se_key_descriptor_t *key_out)
{
  ...
  if ((key_out->storage.method != SL_SE_KEY_STORAGE_EXTERNAL_PLAINTEXT)
      || ((key_in->storage.method != SL_SE_KEY_STORAGE_█████████_VOLATILE)
                               ...
                               const sl_se_key_descriptor_t *key_out)
{
  ...
  if ((key_in->storage.method == SL_SE_KEY_STORAGE_EXTERNAL_PLAINTEXT)
      || (key_in->storage.method == SL_SE_KEY_STORAGE_█████████_IMMUTABLE)
      || (key_out->storage.method == SL_SE_KEY_STORAGE_EXTERNAL_PLAINTEXT)
      || (key_out->storage.method == SL_SE_KEY_STORAGE_█████████_IMMUTABLE)) {
    return SL_STATUS_INVALID_PARAMETER;
  }
