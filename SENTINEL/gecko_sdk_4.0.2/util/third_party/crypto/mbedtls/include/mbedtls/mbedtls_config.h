 ...
 *
 * Any of these options become available by defining MBEDTLS_ECP_█████████_ALT
 ...
 *
 * Example: In case you set MBEDTLS_ECP_█████████_ALT and
 ...
 * mbedtls_ecp_point will not change based on MBEDTLS_ECP_█████████_ALT, so your
