...
#if defined(__GNUC__)
#define __AAT__                             ".aat"
#define __█████████_STORAGE__                ".internal_storage"
#define __SIMEE__                           ".simee"
#elif defined(__ICCARM__)
#define __AAT__                             "AAT"
#define __█████████_STORAGE__                "█████████_STORAGE"
#define __SIMEE__                           "SIMEE"
#endif
...
#define _█████████_STORAGE_BEGIN         (&linker_storage_begin)
...
#define _█████████_STORAGE_END           (&linker_storage_end)
...
#define _█████████_STORAGE_BEGIN         __segment_begin(__█████████_STORAGE__)
...
#define _█████████_STORAGE_END           __segment_end(__█████████_STORAGE__)
