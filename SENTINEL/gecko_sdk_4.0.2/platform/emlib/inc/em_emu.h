 ...
 ******************************************************************************/
  ...
  && !defined(_SILICON_LABS_GECKO_█████████_SDID_200)
...
typedef enum {
  ...
  emuPower_BUMain = EMU_BUINACT_PWRCON_BU█████████,
  /** Main power and backup power connected through diode,
      allowing current from main to backup only. */
  emuPower_MainBU = EMU_BUINACT_PWRCON_█████████BU,
...
typedef enum {
  ...
  emuBuBuInactPwrCon_MainBu  = EMU_BUCTRL_BUINACTPWRCON_█████████BU,
  /** Allow power from main to backup. */
  emuBuBuInactPwrCon_BuMain  = EMU_BUCTRL_BUINACTPWRCON_BU█████████,
...
typedef enum {
  ...
  /** Allow power from backup to main. */
  emuBuBuActPwrCon_MainBu  = EMU_BUCTRL_BUACTPWRCON_█████████BU,
  /** Allow power from main to backup. */
  emuBuBuActPwrCon_BuMain  = EMU_BUCTRL_BUACTPWRCON_BU█████████,
  /** Backup and main power are connected. */
...
/** Backup Power Domain Initialization structure. */
typedef struct {
  bool disMaxComp;                            /**< Disable █████████-BU Comparator. */
...
#define EMU_BUINIT_DEFAULT                                                               \
  {                                                                                      \
    false,                   /* █████████-BU Comparator is not disabled */                    \
