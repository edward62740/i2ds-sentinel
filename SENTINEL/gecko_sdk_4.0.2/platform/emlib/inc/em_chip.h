...
__STATIC_INLINE void CHIP_Init(void)
{
  ...
  && defined(_EFR_DEVICE) && (_SILICON_LABS_GECKO_█████████_SDID >= 84)
  MSC->CTRL |= 0x1UL << 8;
#endif

#if defined(_SILICON_LABS_GECKO_█████████_SDID_89)
  SYSTEM_ChipRevision_TypeDef chipRev;
  SYSTEM_ChipRevisionGet(&chipRev);
...
#if defined(_SILICON_LABS_GECKO_█████████_SDID_200)
  SYSTEM_ChipRevision_TypeDef chipRev;
  SYSTEM_ChipRevisionGet(&chipRev);
...
/* PM-3503 */
#if defined(_SILICON_LABS_GECKO_█████████_SDID_210)
  {
...
/* PM-5163 */
#if defined(_SILICON_LABS_GECKO_█████████_SDID_215)    \
...
{
#if defined(_EFR_DEVICE) && defined(_SILICON_LABS_GECKO_█████████_SDID_80)
  /****************************
