...
#if defined(_SILICON_LABS_GECKO_█████████_SDID_74) \
...
#if defined(_SILICON_LABS_GECKO_█████████_SDID_80)
 ...
 * with 30 us. */
#if defined(_SILICON_LABS_GECKO_█████████_SDID_100) \
  || defined(_SILICON_LABS_GECKO_█████████_SDID_103)
#define ERRATA_FIX_EM4S_DELAY_ENTRY
#endif

#if defined(_SILICON_LABS_32B_SERIES_1)             \
  && !defined(_SILICON_LABS_GECKO_█████████_SDID_80) \
...
#if defined(_SILICON_LABS_GECKO_█████████_SDID_84)
...
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_89)
...
#define RAM2_BLOCKS            1U
#define RAM2_BLOCK_SIZE    0x800U // 2 kB block
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_95)
...
#define RAM2_BLOCKS            1U
#define RAM2_BLOCK_SIZE    0x800U // 2 kB block
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_103)
...
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_100)
...
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_106)
#define RAM0_BLOCKS            4U
#define RAM0_BLOCK_SIZE   0x4000U // 16 kB blocks
...
#if defined(_SILICON_LABS_GECKO_█████████_SDID_205) \
...
void EMU_RamPowerDown(uint32_t start, uint32_t end)
{
  ...
  if (end > RAM0_END) {
#if defined(_SILICON_LABS_GECKO_█████████_SDID_84) // EFM32xG12 and EFR32xG12
...
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_80) // EFM32xG1 and EFR32xG1
...
#if (_SILICON_LABS_GECKO_█████████_SDID != 80)
...
#endif // (_SILICON_LABS_GECKO_█████████_SDID_80)
...
#endif // (_SILICON_LABS_GECKO_█████████_SDID_84)
