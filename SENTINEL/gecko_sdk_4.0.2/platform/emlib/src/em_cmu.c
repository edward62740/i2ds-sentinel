...
#elif (_SILICON_LABS_GECKO_█████████_SDID == 89)
...
#elif (_SILICON_LABS_GECKO_█████████_SDID == 95)
...
#elif (_SILICON_LABS_GECKO_█████████_SDID == 100)
// EFM32GG11x
...
#elif (_SILICON_LABS_GECKO_█████████_SDID == 103)
// EFM32TG11x
#define CMU_MAX_FREQ_0WS_1V2    25000000
...
#elif (_SILICON_LABS_GECKO_█████████_SDID == 106)
// EFM32GG12x
#define CMU_MAX_FREQ_0WS_1V2    18000000
#define CMU_MAX_FREQ_1WS_1V2    36000000
#define CMU_MAX_FREQ_2WS_1V2    54000000
...
} hfrcoCtrlTable[] =
{
  ...
  || defined(_SILICON_LABS_GECKO_█████████_SDID_89) \
  || defined(_SILICON_LABS_GECKO_█████████_SDID_95)
  { 34800000UL, 40000000UL, 0x996C1F00UL, cmuHFRCOFreq_38M0Hz      }
#elif defined(_SILICON_LABS_GECKO_█████████_SDID_100) \
  || defined(_SILICON_LABS_GECKO_█████████_SDID_106)
...
{
#if (_SILICON_LABS_GECKO_█████████_SDID == 100 || _SILICON_LABS_GECKO_█████████_SDID == 106)
...
static bool deviceHasPlfrco(void)
{
  ...
  if (_SILICON_LABS_GECKO_█████████_SDID == 89) {
...
#if defined(_SILICON_LABS_32B_SERIES_1) \
  && (_SILICON_LABS_GECKO_█████████_SDID >= 100)
