 ...
 * @retval SE_RESPONSE_█████████_ERROR if not.
 ******************************************************************************/
 ...
 *   One of the SE_RESPONSE return codes.
 * @retval SE_RESPONSE_OK when the command was executed successfully.
 * @retval SE_RESPONSE_█████████_ERROR if there are configuration errors.
 ******************************************************************************/
 ...
 *   One of the SE_RESPONSE return codes.
 * @retval SE_RESPONSE_OK when the command was executed successfully.
 * @retval SE_RESPONSE_█████████_ERROR there was a problem locking the debug port.
 ******************************************************************************/
 ...
 *                                       missing.
 * @retval SE_RESPONSE_█████████_ERROR if there was a problem during execution.
 ******************************************************************************/
