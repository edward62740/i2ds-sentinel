...
#define  _LOG_CH_CFG_IS_DEFINED_█████████_IMPL(ch)     defined(RTOS_CFG_LOG_##ch)

#define  _LOG_CH_CFG_IS_DEFINED_█████████(ch)          _LOG_CH_CFG_IS_DEFINED_█████████_IMPL(ch)

#define  PP_LIST_ELEM_GET_AT_CHK(list, n)             PP_IF(PP_IS_LTE(n, PP_NARGS list)) (PP_1D_LIST_ELEM_GET_AT(list, n))

#define  _LOG_CH_CFG_IS_DEFINED(ch, n)                _LOG_CH_CFG_IS_DEFINED_█████████(PP_LIST_ELEM_GET_AT_CHK((_LOG_CH_HIERARCHY_LIST_BUILD ch), n))
